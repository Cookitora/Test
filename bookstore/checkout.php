...
<blockquote>
	...
	<input class="hi" style="float: right; margin: 2%;" type="button" name="cancel" value="Вернуться в каталог" onClick="window.location='index.php';" />
</blockquote>
</header>
<?php
session_start();
...
if(isset($_SESSION['id'])){
	...
	echo '<blockquote>';
?>
<input class="button" style="float: right;" type="button" name="cancel" value="Продолжить покупку" onClick="window.location='index.php';" />
<?php
	echo '<h2 style="color: #000;">Выполнение заказа</h2>';
	echo "<table style='width:100%'>";
	echo "<tr><th>Краткое описание заказа</th>";
	echo "<th></th></tr>";
	$row = $result->fetch_assoc();
	echo "<tr><td>ФИО: </td><td>".$row['CustomerName']."</td></tr>";
	echo "<tr><td>Данные карты: </td><td>".$row['CustomerIC']."</td></tr>";
	echo "<tr><td>E-mail: </td><td>".$row['CustomerEmail']."</td></tr>";
	echo "<tr><td>Номер телефона: </td><td>".$row['CustomerPhone']."</td></tr>";
	...
	echo "<tr><td style='background-color: #ccc;'></td><td style='text-align: right;background-color: #ccc;''>Цена: <b>₽".$total."</b></td></tr>";
	echo "</table>";
	echo "</div>";
...
<style> 
header {
	background: url(file:///C:/Users/л/Desktop/bookstore/image/background.jpg);
	width: 100%;
}
header img {
	margin: 1%;
...
.button{
    background-color: rgb(110, 159, 116);
    border: none;
    border-radius: 20px;
    text-align: center;
    transition-duration: 0.5s; 
...
if(!isset($_SESSION['id'])){
	...
	echo 'Name:<br><input type="text" name="name" placeholder="ФИО">';
...
if(isset($_POST['submitButton'])){
	...
	echo "<tr><td>Паспортные данные: </td><td>".$row['CustomerIC']."</td></tr>";
	echo "<tr><td>E-mail: </td><td>".$row['CustomerEmail']."</td></tr>";
	echo "<tr><td>Номер телефона: </td><td>".$row['CustomerPhone']."</td></tr>";
	echo "<tr><td>Пол: </td><td>".$row['CustomerGender']."</td></tr>";
	echo "<tr><td>Адрес: </td><td>".$row['CustomerAddress']."</td></tr>";
